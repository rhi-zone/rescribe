...
fn fixtures_dir() -> std::path::PathBuf {
    ...
    Path::new(crate_root).join("../../../fixtures/odf")
}
...
fn generate_paragraph() {
    write_fixture(
        ...
        OdfDocument {
            ...
            body: OdfBody::Text(vec![TextBlock::Paragraph(Paragraph {
            ...
            body: OdfBody::Text(vec![TextBlock::Paragraph(Paragraph {
                content: vec![
                    ...
                    Inline::Note(Note {
                        ...
                        body: vec![TextBlock::Paragraph(Paragraph {
        ...
        OdfDocument {
            ...
            body: OdfBody::Text(vec![TextBlock::Paragraph(Paragraph {
                content: vec![
                    ...
                    Inline::Field {
                        name: "text:page-number".to_string(),
                        value: "1".to_string(),
                    },
                    Inline::Text(" of ".to_string()),
                    Inline::Field {
                        name: "text:page-count".to_string(),
                        value: "10".to_string(),
                    },
                ],
                ..Default::default()
...
fn generate_styles_text_props() {
    write_fixture(
        ...
        OdfDocument {
            ...
            automatic_styles: vec![StyleEntry {
        ...
        OdfDocument {
            ...
            body: OdfBody::Text(vec![TextBlock::Paragraph(Paragraph {
                content: vec![Inline::Text(
                    "Document with custom page layout.".to_string(),
                )],
                ..Default::default()
            })]),
                ...
                pages: vec![DrawPage {
                    ...
                    shapes: vec![
                        DrawShape {
                            ...
                            content: DrawShapeContent::TextBox(vec![TextBlock::Paragraph(
                                Paragraph {
...
fn generate_adv_bad_zip() {
    ...
    write_raw_fixture(
        "adv-bad-zip",
        "odt",
        b"NOT A ZIP FILE \x00\x01\x02\x03".to_vec(),
    );
}
...
fn generate_adv_large() {
    let blocks: Vec<TextBlock> = (1u32..=500)
        .map(|i| {
            TextBlock::Paragraph(Paragraph {
                content: vec![Inline::Text(format!(
                    "Paragraph number {i} with some filler text to make it non-trivial."
                ))],
                ..Default::default()
            })
        })
