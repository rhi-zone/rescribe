...
//! lives in the standalone `ris` crate — this module is a thin IR
//! translator only.
//!
//! # Example
//!
//! ```
//! use ris::rescribe::parse;
//!
//! let ris = "TY  - JOUR\nAU  - Smith, John\nTI  - A Great Paper\nER  -";
...
pub fn parse_with_options(
    ...
    let (ris_doc, _diags) = crate::parse(input);
...
fn entry_to_node(entry: &RisEntry) -> Node {
