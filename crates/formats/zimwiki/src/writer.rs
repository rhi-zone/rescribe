//! Streaming ZimWiki writer — converts events to ZimWiki text.
...
/// [`finish`](Writer::finish) to flush ZimWiki text to the underlying sink.
...
impl<W: Write> Writer<W> {
    ...
    /// Flush all buffered events as ZimWiki text and return the sink.
