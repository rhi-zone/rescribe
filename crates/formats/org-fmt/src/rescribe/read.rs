...
//!
//! Delegates all parsing to the rest of this crate, then maps the `OrgDoc`
//! AST into rescribe `Node`/`Document` types.
...
pub fn parse_with_options(
    ...
    let (ast, diagnostics) = crate::parse::parse_str(input);
