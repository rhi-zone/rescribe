...
mod tests {
    ...
    fn test_events_heading() {
        ...
        assert!(
            evs.iter()
                .any(|e| matches!(e, OwnedMarkuaEvent::EndHeading))
        );
    }
    ...
    fn test_events_paragraph() {
        ...
        assert!(
            evs.iter()
                .any(|e| matches!(e, OwnedMarkuaEvent::EndParagraph))
        );
        assert!(
            evs.iter()
                .any(|e| matches!(e, OwnedMarkuaEvent::Text(t) if t == "Hello world"))
        );
    }
    ...
    fn test_events_list() {
        ...
        assert_eq!(
            evs.iter()
                .filter(|e| matches!(e, OwnedMarkuaEvent::StartListItem))
                .count(),
            2
        );
    ...
    fn test_events_special_block() {
        ...
        assert!(
            evs.iter()
                .any(|e| matches!(e, OwnedMarkuaEvent::EndSpecialBlock))
        );
    }
    ...
    fn test_events_bold_italic() {
        ...
        assert!(
            evs.iter()
                .any(|e| matches!(e, OwnedMarkuaEvent::StartEmphasis))
        );
        assert!(
            evs.iter()
                .any(|e| matches!(e, OwnedMarkuaEvent::EndEmphasis))
        );
    }
    ...
    fn test_events_footnote_ref() {
        ...
        assert!(
            evs.iter()
                .any(|e| matches!(e, OwnedMarkuaEvent::EndFootnoteRef))
        );
    }
    ...
    fn test_events_subscript_superscript() {
        ...
        assert!(
            evs.iter()
                .any(|e| matches!(e, OwnedMarkuaEvent::StartSuperscript))
        );
    }
