...
//! Streaming Creole writer — converts a stream of events to Creole text.
//!
//! # Example
//! ```no_run
...
/// [`finish`](Writer::finish) to flush Creole text to the underlying sink.
...
impl<W: Write> Writer<W> {
    ...
    /// Flush all buffered events as Creole text and return the sink.
...
fn events_to_doc(events: Vec<OwnedEvent>) -> CreoleDoc {
