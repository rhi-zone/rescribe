...
//! all Typst markup-generation logic lives in that standalone crate now
...
//! unrecognized kinds) is unchanged from the pre-extraction version of this
//! file, which hand-emitted Typst markup text directly.
