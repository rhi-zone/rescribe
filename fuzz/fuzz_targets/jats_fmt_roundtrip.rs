...
//! jats-fmt native AST roundtrip fuzz target.
//!
//! Constructs an arbitrary JatsDoc from fuzz data, emits it to XML bytes,
...
//! what generic XML can express, regardless of JATS-specific IR modeling.
